...
#   wget -qO- https://raw.githubusercontent.com/TimUx/FestSchmiede/v2.3.12/install.sh | bash
#
...
#   FESTSCHMIEDE_VERSION              – Release-Tag (Standard: 2.3.12)
...
FESTSCHMIEDE_VERSION="${FESTSCHMIEDE_VERSION:-2.3.12}"
